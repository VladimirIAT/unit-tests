...
//        System.out.println(sum(2_147_483_647, 2)); //
        ...
        System.out.println(Calculator.calculatingDiscount(1000, 90));
        //Проверка калькулятора скидок
        assert 100 == Calculator.calculatingDiscount(1000, 70);
    }
    ...
    public static int sum(int a, int b) {
        assert Integer.MAX_VALUE - a >= b: "Вышли за пределы интеджера";
        return a + b;
    }
    ...
    public static void checkingShoppingCart() {
        ...
        for (String product : products) {
            if (product.equals("apple")) {
                ...
                assert product.equals("water") : "Unknown category for the product " + product;
            }
        }
    }
